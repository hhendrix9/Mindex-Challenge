...
public class Employee {
    ...
    private List<ReportingStructure> ReportingStructure;
    ...
    public List<ReportingStructure> getReportingStructure() {
        return ReportingStructure;
    }

    public void setReportingStructure(List<ReportingStructure> ReportingStructure) {
